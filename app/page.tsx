    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-blue-100 origin-top scale-90 lg:scale-100">
      ...
      <section className="pt-40 pb-20 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-slate-500 font-medium leading-relaxed max-w-[480px] mb-10">{subtitle}</p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="https://wa.me/5527992655561"
                className="flex items-center justify-center gap-3 bg-blue-600 text-white px-8 py-5 rounded-2xl font-bold text-sm uppercase tracking-widest hover:bg-blue-700 transition-all shadow-xl shadow-blue-100"
              >
                Solicitar Demonstracao <ChevronRight size={18} />
              </Link>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="space-y-4">
              ...
              <p className="text-slate-500 text-sm leading-relaxed font-medium">
                Envio automatico dos eventos de SST para total conformidade.
              </p>
            </div>
            <div className="space-y-4">
              <div className="text-blue-600">
              ...
              <p className="text-slate-500 text-sm leading-relaxed font-medium">
                Documentacao integrada, atualizada e sempre acessivel.
              </p>
            </div>
            <div className="space-y-4">
              <div className="text-blue-600">
              ...
              <p className="text-slate-500 text-sm leading-relaxed font-medium">
                Indicadores estrategicos em tempo real para sua empresa.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {posts.length > 0 ? (
              posts.map((post: PostData) => (
                <div
                  key={post._id}
                  className="bg-white rounded-3xl p-6 border border-slate-100 group shadow-sm hover:shadow-md transition-all"
                >
                  ...
                  <div className="flex justify-between items-center border-t border-slate-50 pt-4">
                    ...
                    {post.slug ? (
                      <Link
                        ...
                        className="text-blue-600 font-bold text-[9px] uppercase tracking-widest hover:underline flex items-center gap-1"
                      >
                        Ler noticia <ChevronRight size={12} />
                      </Link>
                    ) : null}
                  </div>
                </div>
              ...
              <p className="text-slate-500 font-medium italic uppercase font-black tracking-widest">
                Aguardando novas publicacoes...
              </p>
            )}
          </div>
        </div>
      ...
      <footer className="bg-white py-12 border-t border-slate-100 mt-12 text-center">
        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
          (c) 2026 Novavix Sistemas - Gestao SST Inteligente
        </p>
      </footer>
    </div>
  )
