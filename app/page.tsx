...
// FORÇA O NEXT.JS A BUSCAR DADOS NOVOS SEMPRE
      ...
      <section className="pt-40 pb-20 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-5xl lg:text-6xl font-black text-slate-900 tracking-tighter leading-[0.95] mb-8 whitespace-pre-line italic uppercase">
              {title}
            </h1>
          ...
          <div className="relative">
            <div className="bg-slate-900 rounded-[40px] aspect-video w-full overflow-hidden shadow-2xl border-[8px] border-white relative flex flex-col items-center justify-center p-12">
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <p className="text-white/20 font-medium text-[11px] italic mt-4 italic font-black uppercase tracking-widest">Interface de Gestão</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="space-y-4">
              ...
              <p className="text-slate-500 text-sm leading-relaxed font-medium italic uppercase font-black tracking-widest">Envio automático dos eventos de SST.</p>
            </div>
            <div className="space-y-4">
              ...
              <p className="text-slate-500 text-sm leading-relaxed font-medium italic uppercase font-black tracking-widest">Documentação integrada e atualizada.</p>
            </div>
            <div className="space-y-4">
              ...
              <p className="text-slate-500 text-sm leading-relaxed font-medium italic uppercase font-black tracking-widest">Indicadores em tempo real para sua empresa.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="blog" className="py-24 bg-white scroll-mt-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {posts.length > 0 ? (
              posts.map((post: any) => (
                <div key={post._id} className="bg-white rounded-3xl p-6 border border-slate-100 group">
                  <div className="relative aspect-[16/10] rounded-xl overflow-hidden mb-6 bg-slate-100">
                    {post.imagemUrl ? (
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed mb-6 line-clamp-3">{post.resumoPost}</p>
              ...
              <p className="text-slate-500 italic uppercase font-black tracking-widest">Nenhuma postagem encontrada.</p>
            )}
          </div>
        </div>
      </section>
